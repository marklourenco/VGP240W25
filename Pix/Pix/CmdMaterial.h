...
public:
	...
	const char* GetDescription() override
	{
		return "SetMaterialEmissive(r, g, b)\n"
			"\n"
			"- Set emissive color for a material";
	}
...
public:
	...
	const char* GetDescription() override
	{
		return "SetMaterialAmbient(r, g, b)\n"
			"\n"
			"- Set ambient color for a material";
	}
...
const char* GetName() override
	...
	const char* GetDescription() override
	{
		return "SetMaterialDiffuse(r, g, b)\n"
			"\n"
			"- Set diffuse color for a material";
	}
...
const char* GetName() override
	...
	const char* GetDescription() override
	{
		return "SetMaterialSpecular(r, g, b)\n"
			"\n"
			"- Set specular color for a material";
	}
